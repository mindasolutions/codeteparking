...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">You cannot park your vehicle right now.</h1>
      <p class="lead">We are very sorry, but at the moment we do not have free parking spaces. Please try again later.</p>
    </div>
