...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">You parked the <?php echo $data['carType']; ?> successfully</h1>
      <p class="lead">Your <?php echo $data['carType']; ?> has been succesfuly parked on <?php echo $data['parkedId']; ?> side.</p>
    </div>
